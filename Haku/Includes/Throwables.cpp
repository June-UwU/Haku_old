...
const char* Throwables::what() noexcept
{
	...
	FormatMessageA(FORMAT_MESSAGE_ALLOCATE_BUFFER | FORMAT_MESSAGE_FROM_SYSTEM | FORMAT_MESSAGE_IGNORE_INSERTS, 0, Code, LANG_SYSTEM_DEFAULT, LPSTR(&ErrorString), 0, 0);
	if (!ErrorString)
	{
