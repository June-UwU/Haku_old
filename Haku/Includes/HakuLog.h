...
inline std::string Normalize(const std::string& msg) noexcept
{
	return msg;
}
inline std::string Normalize(const char* msg) noexcept
{
...
inline std::string Normalize(const Type msg) noexcept
{
